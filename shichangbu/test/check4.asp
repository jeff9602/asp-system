...
<body style="text-align: center;background: rgba(193,210,240,0.7)" oncopy="alert('对不起，本网页禁止复制！');return false;" >
<div style="height:40px;width: 760px;position: relative;margin: 0 auto; ">
<form action="check4.asp" method="post" style="margin-top: 40px">
	<label >
  <font color="white"> 是否达标楼宇信息查询 </font>
  <select name="id1" style="background-color:transparent; overflow: hidden;-webkit-appearance:none;color: orange"> <option value='1' >达标楼宇</option> <option value='未投产楼宇查询'>未达标楼宇</option>
  </select>
  <input type="submit" value="查询" style="margin-left: 10px" class="button">
	<a style="margin-left: 50px">楼内客户数</a></select> 
  <select name="id2" style="background-color:transparent; overflow: hidden;-webkit-appearance:none;color: orange"> <option value='=' >=</option> <option value='>'>></option>  <option value='<'><</option> </select><input type="number" name="id" placeholder="请输入数量" style="background-color:transparent;display:inline-block;margin-top: -2px;vertical-align:middle;color: orange" >
